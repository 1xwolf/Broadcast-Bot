...
client1.once("ready", () => {
  ...
  client1.user.setActivity({ name: "Team Lion", type: ActivityType.Streaming, url: "https://www.twitch.tv/samvksa" });
});

client2.once("ready", () => {
  console.log("Bot 2 is Ready!");
  client2.user.setActivity({ name: "Team Lion", type: ActivityType.Streaming, url: "https://www.twitch.tv/samvksa" });
});
...
client1.on("messageCreate", async (message) => {
  ...
  const embed = new EmbedBuilder()
    ...
    .setImage('https://cdn.discordapp.com/attachments/1456543407416676362/1457587094867148895/THANKS_FOR_SUBSCRIBE_5.png?ex=695c8b44&is=695b39c4&hm=8a5808af445806fe493f8c219c4dab689788d94d7667fe99ea48d88935afebbf&')
    .setFooter({ text: 'This bot code by Flat Store', iconURL: 'https://cdn.discordapp.com/attachments/1456543407416676362/1457587094867148895/THANKS_FOR_SUBSCRIBE_5.png?ex=695c8b44&is=695b39c4&hm=8a5808af445806fe493f8c219c4dab689788d94d7667fe99ea48d88935afebbf&' });
